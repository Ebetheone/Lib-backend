...
import { AuthPhoneResetPasswordInputType } from "../inputTypes"
...
export const AuthPhoneResetPassword = mutationField("authPhoneResetPassword", {
  type: AuthVerifyTokenType,
  args: {
    input: nonNull(arg({ type: AuthPhoneResetPasswordInputType })),
  },
  resolve: async (_root, { input }, ctx) => {
    ...
    if (input.phone !== verifiedUser.phone)
